                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h1 class="h1 text-white d-inline-block mb-0">Invoice Transaksi</h1>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header bg-transparent">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <p>Dari <br>
                                    {{$pembelian->nama_pemasok}} <br>
                                    Kuningan</p>
                                </div>
                                <div class="col-4">
                                    <p>No Referensi : {{$pembelian->ref}} <br>
                                    Total Pembelian : {{$pembelian->banyak}} <br>
                                    Tanggal : {{$pembelian->tgl_beli}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{$pembelian->banyak}}</td>
                                            <td>Rp.{{$pembelian->subtotal}}</td>
                                        </tr>
                                    </tbody>
                                    <tr>
                                        <th colspan="3">Grandtotal</th>
                                        <td>Rp.{{$pembelian->grandtotal}}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
