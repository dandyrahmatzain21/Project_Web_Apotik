                ...
                <div class=" col ">
                    <div class="card">
                        <div class="card-header bg-transparent">
                            <h1 style="text-align:center" class="mb-0">LAPORAN PEMBELIAN</h1>
                        </div>
                        <div class="card-body">
                            <p>Berikut Data Pembelian Yang Terdaftar Dari Tanggal {{$tgl_awal_pembelian}} Sampai Tanggal {{$tgl_akhir_pembelian}}</p>
