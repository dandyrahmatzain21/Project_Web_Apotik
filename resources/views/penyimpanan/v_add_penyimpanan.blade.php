...
@section('judul_halaman','TAMBAH DATA PENYIMPANAN')
@section('title','APOTIK ABC')

@section('konten')
    <form method="POST" action="/penyimpanan/insert" enctype="multipart/form-data">
        @csrf

        <div class="form-group">
            <label for="nama_penyimpanan">Nama Penyimpanan</label>
            <input type="text" name="nama_penyimpanan" class="form-control @error('nama_penyimpanan') is-invalid @enderror" id="nama_penyimpanan" placeholder="Nama penyimpanan" value="{{old('nama_penyimpanan')}}">
