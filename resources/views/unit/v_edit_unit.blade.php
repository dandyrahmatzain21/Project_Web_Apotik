...
@section('judul_halaman','EDIT UNIT')
@section('title','APOTIK ABC')

@section('konten')
    <form method="POST" action="/unit/update/{{$unit->id_unit}}" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="nama_unit">Nama Unit</label>
            <input type="text" name="nama_unit" class="form-control @error('nama_unit') is-invalid @enderror" id="nama_unit" placeholder="Nama Unit" value="{{$unit->nama_unit}}">
